      ...
      <div className='dl-left'>
        <div className='dl-left-top'>
          <div className='dl-lt-top'>
            ...
            <div className='dl-ltt-right'>
              <div className='dl-logo'>
                <p>DesignHype.xyz</p>
              </div>
            </div>
          </div>
          <div className='dl-lt-bot'>
            <p> Transform your vision into reality with our design subscription. </p>
            <div className='dl-icons-logo'>
              <img src={require('../../Assets/asterisk.png')} alt='' className='logo-icon' />
              <img src={require('../../Assets/lightning-bolt-shadow.png')} alt='' className='logo-icon' />
              <img src={require('../../Assets/chevron-arrow-down.png')} alt='' className='logo-icon' />
            </div>
          </div>
        </div>
        <div className='dl-left-bot'>
          <div className='dl-left-bot-left'>
            <img src={require('../../Assets/pattern.png')} alt='' />
          </div>
          <div className='dl-left-bot-right'>
            <div className='dl-lbr-top'>
              <div className='dl-lbr-top-content'>
                <p>See Plans</p>
                <img src={require('../../Assets/lightning-bolt-shadow.png')} alt='' className='logo-icon' />
                {/* <img src={require('../../Assets/external-link-square-with-an-arrow-in-right-diagonal.png')} alt='' className='logo-icon' /> */}
              </div>
            </div>
            <div className='dl-lbr-bot'>
